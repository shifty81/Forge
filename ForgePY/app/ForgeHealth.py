...
def evaluate_project(root: Path, contract: ProjectContract | None = None) -> ProjectHealth:
    ...
    # GitHub and ForgePY Internal Git are the primary source-control authorities.
    ...
    if git.get("gitReady"):
        ...
        if not source_control.get("internalGitConfigured"):
            _push(warnings, "ForgePY Internal Git not configured")
