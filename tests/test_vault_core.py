...
def make_universal_patch(path: Path, *, project: str, patch_id: str, rel: str, before: bytes | None, after: bytes) -> None:
    ...
    manifest = {
        "schema": "vault.patch.v1",
        "engine": "vault",
        "project": project,
        "patchId": patch_id,
        "title": "Vault universal patch test",
        "files": [row],
    }
