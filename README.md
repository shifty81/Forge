...
**Current integrated candidate:** `0.5.0-candidate.797` (`FORGEPY-F797`)

Current focus: native GUI foundation plus normalized project-owned PCC delegation and Vault-backed asset dependency recovery. Internal PCCs remain valid standalone authorities while ForgePY can launch them, preserve/delegate their root-drop patches, and resolve hash-bound project assets from Vault/backup catalogs.
